...
public:
    STATE(COLOR _color,float _life,const map<string,float>& _warrior_life_map){
       ...
       if(color==RED) state_name="red";
       else if(color==BLUE) state_name="blue";
...
//       warrior_life_map["dragon"]=3;
       ...
       void warrior_born(string _warrior_name){
           ...
           //if(color==RED) printf("red ");
           //else printf("blue ");
           cout<<state_name<<" "<<tmp<<" "<<warrior_num<<" born with strength "<<warrior_life_map[tmp]<<","<<warrior_count_map[tmp]+1<<" "<<tmp<<" in "<<state_name<<" headquarter"<<endl;
           ...
           if(tmp=="iceman"){
               ...
               float loyalty=life-warrior_life_map[tmp];
               ...
               float morale=(life-warrior_life_map[tmp])/warrior_life_map[tmp];
